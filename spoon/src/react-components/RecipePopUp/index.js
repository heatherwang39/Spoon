...
PROBLEM: INVALID HOOK CALL, BECAUSE I CAN ONLY CALL HOOKS FROM REACT FUNCTIONS...
...
function RecipePopup() {
    ...
    const { title, author, photo, numLikes, children, openPopup, setOpenPopup } = this.props;
